...
def calculate_metrics(true_labels, predicted_labels, num_classes):
    ...
    plt.savefig('svd_4.png', dpi=300, bbox_inches='tight')
...
if __name__ == "__main__":
    ...
    # params_dict = torch.load('svd_10000_4_300.pt')
    params_dict = torch.load('svd-word-vectors.pt')
    word_vectors_dict = params_dict['word_vectors_dict']
    vocab = params_dict['vocab']
